...
function getStageStr() {
    ...
    StageOperation.prototype = {
        ...
        initStage: function(stage_id, element) {
            ...
            if ("undefined" == typeof stage_id) {
                ...
                layer_grid.add(background), layer_grid.draw(), layer = new Konva.Layer({
                    id: Math.uuid()
                }), stage.add(layer), $("#container").height(768), $("#container").width(1024)
            } else {
                var stageObjJson = eval("initConfig." + initjson.editCallbackFunction + "(stage_id)");
                stage = Konva.Node.create(stageObjJson, "container"), layer_grid = stage.getLayers()[0], layer = stage.getLayers()[1], this.stage = stage, this.layer = layer;
                var groups = stage.find("Group");
                groups.each(function(e) {
                    stageOper.addModuleEvent(e), stageOper.setGroupImage(e)
                }), layer.draw(), $("#container").height(stage.height()), $("#container").width(stage.width())
            }
            this.element = element, this.stage = stage, this.layer = layer, this.layer_grid = layer_grid, this.initResolution(), this.initBackground()
        },
        initResolution: function() {
            ...
            $("#selectResolution").html(r), $("#selectResolution").val(e + "*" + t), form.render("select"), form.on("select(selectResolution)", function(e) {
                var t = new Array;
                t = e.value.split("*"), stageOper.setStageSize({
                    width: t[0],
                    height: t[1]
                }), stageOper.setStageGrid($("#hbfzx").is(":checked")), stageOper.setStageBackground()
            })
        },
        initBackground: function() {
            var e = this.stage.findOne(".layer_background"),
                t = e.fill();
            $("#stageBackgroundColor").val(t), colorpicker.render({
                ...
                format: "rgb",
                change: function(e) {
                    $("#stageBackgroundColor").val(e), stageOper.setStageBackground(e)
                }
            })
        },
        getStageJson: function() {
            try {
                ...
                e.each(function(e) {
                    ...
                    "BASELINE" == t && stageOper.removeLineEdit(e),
                    "FLOWLINE" == t && stageOper.removeFlowLineEdit(e)
        ...
        setStageSize: function(e) {
            this.stageMaxMin("restore"), this.stage.width(e.width), this.stage.height(e.height), this.layer_grid.clip({
                ...
                width: e.width,
                height: e.height
            }), $("#container").height(e.height), $("#container").width(e.width), this.stage.draw()
        },
        ...
        setLeftModulePanel: function(e) {
            for (var t = "", a = 0; a < e.length; a++) {
                var r = e[a].groupName,
                    i = e[a].moduleItem;
                t += ' <div class="layui-colla-item">', t += '<h2 class="layui-colla-title">' +
                r + "</h2>", t += 0 == a ? '<div class="layui-colla-content layui-show" style="padding: 5px">' :
                 '<div class="layui-colla-content" style="padding: 5px">', t += '<div class="module_panel">';
                for (var o = 0; o < i.length; o++) {
                    var n = i[o].moduleName,
                        l = i[o].iconBase64,
                        d = i[o].moduleJson,
                        s = Math.uuid();
                    this.moudleObj[s] = d, t += "<div class=\"module_img_d\" style='display: flex;justify-content:safe center;
                    align-items: center;flex-direction: column;'>",
                    t += "<img alt='" + n + "' id='" + s + "' style='cursor:move'
                    draggable='true'
                    ondragstart='dragImage(event)'
                     class=\"module_img\"  src=\"" + l + '">',
                     t += "</div>"
                }
                t += "</div>", t += "</div>", t += "</div>"
            }
            $(".main_page_center .main_page_center_left .layui-tab .layui-tab-content .layui-tab-item .basemodule ").html(t), this.element.render("collapse", "module_panel")
        },
        setLeftMapStorageModulePanel: function(e) {
            ...
            $(".main_page_center .main_page_center_left .layui-tab .layui-tab-content .layui-tab-item .mapStorageModule ").html(t), this.element.render("collapse", "module_panel")
        },
        addModuleToStage: function(e, t) {
            var a = Konva.Node.create(e);
            return a.position(t), a.dragBoundFunc(function() {}), this.layer.add(a), this.setGroupImage(a), this.addModuleEvent(a), a.draw(), a
        },
        setGroupImage: function(moduleObject) {
            ...
            if (-1 != moduleType.indexOf("GIF") && "undefined" != typeof moduleType) {
                ...
                gifler(urlImage).frames(canvas, function(e, t) {
            ...
            if (-1 != moduleType.indexOf("ECHART") && "undefined" != typeof moduleType) {
                ...
                var stageBox = stageOper.stage.container().getBoundingClientRect(),
                    areaPosition = {
                ...
                "ECHART_GAUGE" == moduleType && myChart.setOption(eval(moduleObject.attrs.echartURL + "()")), "ECHART_THERMOMETER" == moduleType && myChart.setOption(eval(moduleObject.attrs.echartURL + "(0,100,20)")), "ECHART_realTimeLine" == moduleType && myChart.setOption(eval(moduleObject.attrs.echartURL + "('')")), myChart.on("finished", function() {
        ...
        addModuleEvent: function(e) {
            e.on("mouseover", function(e) {
                var t = e.target;
                document.body.style.cursor = -1 != t.name().indexOf("edit_anchor") ? "crosshair" : "move"
        ...
        addModuleTransformEvent: function() {
            ...
            this.stage.on("mousedown touchstart", function(i) {
                if (i.target === stageOper.stage) {
                    $("#zjsx").html(""), e = stageOper.stage.getPointerPosition().x, t = stageOper.stage.getPointerPosition().y, a = stageOper.stage.getPointerPosition().x, r = stageOper.stage.getPointerPosition().y;
            ...
            this.stage.on("mousemove touchmove", function() {
                null != o && 1 === stageOper.stage.scaleX() && (a = stageOper.stage.getPointerPosition().x, r = stageOper.stage.getPointerPosition().y, o.setAttrs({
            ...
            this.stage.on("mouseup touchend", function(e) {
                try {
                    ...
                    if (1 == a.length);
                        ...
                        var r = e.target,
                            n = r.parent().attrs.moduleType;
                        (-1 == r.name().indexOf("edit_anchor") || "FLOWLINE" != n && "BASELINE" != n) && $("#zjsx").html("")
                    }
                } catch (e) {}
                var l = stageOper.stage.find(".jyzt_module_group").toArray(),
                    d = 0;
                try {
            ...
            this.stage.on("click tap", function(e) {
                if (null == o) {
                    ...
                    if (a = 0 == r ? !1 : i.nodes().indexOf(e.target.getParent()) >= 0, t || a) {
                        if (t && a) {
                            const n = i.nodes().slice();
                            ...
                            if (l.each(function(e) {
                                    var t = e.attrs.moduleType;
                                    "BASELINE" == t && stageOper.removeLineEdit(e), "FLOWLINE" == t && stageOper.removeFlowLineEdit(e)
                                }), 1 == i.nodes().length && ("FLOWLINE" == i.nodes()[0].attrs.moduleType || "Arrow" == i.nodes()[0].attrs.moduleType || "BASELINE" == i.nodes()[0].attrs.moduleType)) return layer.msg("已有组件类型为[" + i.nodes()[0].attrs.moduleType + "]不能参与多选", {
                                offset: "t",
                                anim: 6,
                                icon: 2
                            }), 1 == i.nodes().length && stageOper.showModuleAttr(i.nodes()[0]), void 0;
                            if ("FLOWLINE" != e.target.getParent().attrs.moduleType && "Arrow" != e.target.getParent().attrs.moduleType && "BASELINE" != e.target.getParent().attrs.moduleType) {
                                const d = i.nodes().concat([e.target.getParent()]);
                                i.nodes(d)
                            } else layer.msg("组件类型为[ " + e.target.getParent().attrs.moduleType + " ]不能参与多选", {
                                offset: "t",
                                anim: 6,
                                icon: 2
                            })
                    ...
                    1 == i.nodes().length && stageOper.showModuleAttr(i.nodes()[0]), i.moveToTop(), stageOper.layer.draw()
                }
            })
        },
                ...
                d++) {
                    ...
                    m.on("dragmove", function(t) {
                        var a = t.currentTarget,
                            ...
                            y = n[2 * d + 2],
                            f = n[2 * d + 3];
                        n[2 * d] = r, n[2 * d + 1] = l, i.points(n), o.points(n), "undefined" != typeof u && (u.x(m + (r - m) / 2), u.y(g + (l - g) / 2)), "undefined" != typeof h && (h.x(r + (y - r) / 2), h.y(l + (f - l) / 2)), e.getLayer().batchDraw()
                    }), e.add(m)
                }
                e.draw()
            }
        ...
        addModuleContextmenu: function() {
            this.stage.on("contextmenu", function(e) {
                if (e.evt.preventDefault(), e.target !== stageOper.stage) {
                    ...
                    var t = stageOper.stage.container().getBoundingClientRect();
                    menuNode.style.top = t.top + stageOper.stage.getPointerPosition().y + 4 + "px", menuNode.style.left = t.left + stageOper.stage.getPointerPosition().x + 4 + "px"
                }
            })
        },
        ...
        showModuleAttr: function(moduleObject) {
            ...
            if ("undefined" != typeof moduleAttrs) {
                ...
                $("#zjsx").html(moduleAttrHtml), layui.form.render("select", "zjsx");
                for (var j = 0; j < color_array.length; j++) {
                    ...
                    ! function(e, t, a, r) {
                        colorpicker.render({
                            ...
                            predefine: !0,
                            change: function(a) {
                                $("#" + e + "_input_color").val(a), stageOper.setModuleAttr(moduleObject, r, t, a)
                            }
                        })
                ...
                for (var j = 0; j < input_text_array.length; j++) {
                    ...
                    ! function(e, t, a, r) {
                        $("#" + e + "_input_text").on("input", function() {
                            var e = $(this).val();
        ...
        stageMaxMin: function(e) {
            var t = 1,
                a = 1;
            "max" == e && (t = this.stage.scale().x + .05, a = this.stage.scale().y + .05, this.stage.draggable(!0), layer.msg("放大或缩小状态下不可以框选组件", {
                offset: "48px",
                anim: 6,
                icon: 4
            })), "min" == e && (t = this.stage.scale().x - .05, a = this.stage.scale().y - .05, this.stage.draggable(!0), layer.msg("放大或缩小状态下不可以框选组件", {
                offset: "48px",
                anim: 6,
                icon: 4
                ...
                x: t,
                y: t
            }), this.stage.draw(), $("#stageProportion").val(parseInt(100 * t) + "%")
        },
...
$(function() {
    ...
    menuNode = document.getElementById("menu"), layui.use(["element", "form", "colorpicker", "slider", "tree", "table"], function() {
        ...
        colorpicker = layui.colorpicker, slider = layui.slider, tree = layui.tree, form.on("checkbox(hbfzx)", function(e) {
            stageOper.setStageGrid(e.elem.checked), e.elem.checked ? $("#gridColorGroup").show() : ($("#gridColorGroup").hide(), $("#gridColor").val(""))
            ...
            predefine: !0,
            change: function(e) {
                $("#gridColor").val(e), stageOper.setGridColor(e)
            }
        ...
        jyztEchartOption = new EchartOption, initConfig = new InitConfig, $.ajaxSettings.async = !1,
         $.getJSON("config/init.json", function(e) {
            initjson = e
        }),
        ...
        stageOper.setLeftMapStorageModulePanel(module_base), container = stageOper.stage.container(), container.addEventListener("dragover", function(e) {
            e.preventDefault()
        ...
        }), stageOper.stage.on("dragmove", function() {}), stageOper.addModuleTransformEvent(), stageOper.addModuleContextmenu(), stageOper.setStageKeyboardEvent(), $("#left_shrink").click(function() {
            $(".main_page_center_left").slideToggle(100, function() {
                $(this).is(":visible") ? $("#left_shrink").attr("class", "layui-icon layui-icon-left") : $("#left_shrink").attr("class", "layui-icon layui-icon-right")
            })
        }), $("#right_shrink").click(function() {
            $(".main_page_center_right").slideToggle(100, function() {
                $(this).is(":visible") ? $("#right_shrink").attr("class", "layui-icon layui-icon-right") : $("#right_shrink").attr("class", "layui-icon layui-icon-left")
            })
        }), $("#yl").click(function() {
